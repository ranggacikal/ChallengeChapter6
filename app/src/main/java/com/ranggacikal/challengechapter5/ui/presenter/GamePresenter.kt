...
class GamePresenter(val data: GameView) {
    ...
    fun validasiHasilCom(player: Int) {
        ...
        val validasiPlayer = HasilValidasiPlayerData()
        validasiPlayer.hasilValidasiPlayer = hasilValidasiPlayer
        data.hasilValidasiPlayer(validasiPlayer)
    }
